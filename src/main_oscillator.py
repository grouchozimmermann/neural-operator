...
initialData = np.load(Path("./src/data/pendulum/PendulumRHS10000_M1.0_N4_n1000_rescaled_crazy.npy"))
targetData = np.load(Path("./src/data/pendulum/PendulumSol10000_M1.0_N4_n1000_rescaled_crazy.npy"))

#initialData = np.load(Path("./src/data/harmonic_oscillator/HarmOscRHS10000_M1.0_over_dampened.npy"))
#targetData = np.load(Path("./src/data/harmonic_oscillator/HarmOscSol10000_M1.0_over_dampened.npy"))
